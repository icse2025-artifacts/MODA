...
def get_args():
    ...
    parser.add_argument('--wf_cohesion', type=float, default=1.0, help='weight factor for [modular] loss cohesion')
    parser.add_argument('--wf_coupling', type=float, default=1.0, help='weight factor for [modular] loss coupling')
...
def main():
    ...
    model_checkpoint_dir = f"./temp/{model_type}_{dataset_type}/"
    mod_checkpoint_path = os.path.join(model_checkpoint_dir,
                                       f"model__bs128__ep200__lr0.05__coh{args.wf_cohesion}_coup{args.wf_coupling}_comp{args.wf_compactness}/model.pt")
    raw_checkpoint_path = os.path.join(model_checkpoint_dir,
                                       f"model__bs128__ep200__lr0.05__coh0.0_coup0.0_comp0.0/model.pt")
